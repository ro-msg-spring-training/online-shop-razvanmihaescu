...
create table address (id integer not null, city varchar(255), country varchar(255), county varchar(255), street_address varchar(255), orders_id integer, primary key (id)) engine=InnoDB;
...
create table orders (id integer not null, created_at datetime, customer_user_id integer, shipped_from_id integer, primary key (id)) engine=InnoDB;
...
alter table address add constraint FK10uwx1jrmhr5q4bvt2lqn0br1 foreign key (orders_id) references orders (id);

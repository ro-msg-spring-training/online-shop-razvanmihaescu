...
create table orders (id integer not null auto_increment, created_at datetime, customer_user_id integer, delivery_location_id integer, shipped_from_id integer, primary key (id)) engine=InnoDB;
create table product (product_id integer not null auto_increment, description varchar(255), image_url varchar(255), name varchar(255), price float, weight double precision, category_id integer, primary key (product_id)) engine=InnoDB;
...
create table user (user_id integer not null auto_increment, email varchar(255), first_name varchar(255), last_name varchar(255), password varchar(255), username varchar(255), roles_name varchar(255), primary key (user_id)) engine=InnoDB;
